...
**phtEnthalpyFoam** — fluid flow in porous media without phase changes and chemical reactions. This solver allows one to simulate flows through the "inert" porous materials like rocks, metallic balls, etc. as in sensible heat thermal energy storage or flow through the self-heating porous media.

**porousHeatTransferFoam** — fluid flow in porous media. Optional modeling of phase transitions in the condenced phase like granular PCM. This solver allows one to model flows in packed bed thermal energy storages with phase changes.

**phtMetalExtractionFoam** — gas flow through a four-component reacting solid porous phase consisting of an inert, a combustible, a melting/evaporating component and an optional solid combustion product.
